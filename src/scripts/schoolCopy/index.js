...
export default class Index extends wepy.page {
  ...
  methods = {
    ...
    toDetial: function (e) {
      let reportType = ''
      let logdate = this.ajaxData.logdate;
      console.log('logdate')
      ...
      if (this.currentTab == '0') {
        ...
        reportType = 2
        logdate = this.weekInfo.index;
      } else if (this.currentTab == '2') {
        reportType = 3
      }
      wepy.navigateTo({url: '../pages/schoolDetail?id=' + e.currentTarget.dataset.id + '&reportType=' + reportType + '&logdate=' + logdate})
    }
  }
